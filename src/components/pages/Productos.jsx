...
const Productos = () => {
  return (
    ...
    <div className='md:gap-0 p-10 xl:ml-20 xl:mr-20' >
      <h1 className='text-2xl xl:text-3xl font-bold text-primary tracking-[3px] m-auto' >Control y registro de productos.</h1><br/>
      ...
      <form className='w-full max-w-2xl  m-auto '>
         <div className='flex flex-wrap m-auto bg-emerald-800 xl:rounded-[10%] rounded-[5%] p-5'>
