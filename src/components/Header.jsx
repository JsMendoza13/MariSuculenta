...
const Header = () => {
  ...
  return (
    <header className="flex item-center justify-between xl:justify-start w-full py-13 px-5 xs:px-40 h-[10vh] z-50 bg-secundary">
      ...
      <nav
        className={`fixed w-[80%] md:w-[20%] xl:w-full h-full ${
          showMenu ? "left-0" : "-left-full"
        }  top-0 xl:static flex-2 flex flex-col xl:flex-row items-center justify-center gap-10 bg-secundary transition-all duration-500 z-50`}
      >
        {/* Navegacion */}
