      ...
      <section className="min-h-[90vh] grid grid-cols-1 md:grid-cols-8 bg-secundary gap-8 md:gap-0 p-10">
        ...
        <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
          <div className="flex flex-col gap-5">
            <h1 className=" text-4xl xl:text-7xl font-bold xl:leading-[7.5rem] text-white">
              Bienvenidos a Maria{" "}
              <span className="text-primary tracking-[3px] ">Suculentas</span>
            </h1>
            <p className="text-gray-400 text-xl xl:text-2xl leading-[2.5rem]">
              La empresa María Suculentas SAS es una empresa que se encarga del
              cultivo y distribución de plantas de “apoyo emocional”
            </p>
        ...
        <div className="md:col-span-3 flex items-center justify-center relative ">
          <div>
            ...
            <div className="relative bg-white shadow-2xl rounded-lg xl:p-4 p-2 w-[80%] flex flex-col justify-center gap-2 max-w-[250px] ml-[50%] -translate-x-[60%] xl:-mt-40 -mt-[19%] ">
              ...
              <div className="flex items-center gap-2 text-[120%] font-medium text-gray-400">
